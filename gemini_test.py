...
def resolve_linked_section(session, href: str, base_url: str, link_text: str = "", depth=0):
    ...
    try:
        ...
        # Save to global cache to optimize all subsequent production loops
        session._global_parsed_cache[cache_key] = copy.deepcopy(result_data)
        return result_data
